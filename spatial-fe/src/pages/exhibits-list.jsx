...
function ExhibitsList() {
  return (
    <div className="mx-auto w-[70%]">
      ...
      <h2 className="text-2xl font-['Roboto_Condensed'] font-light text-[#979797] mb-16">Insert Subtitle</h2>
      <div className="flex justify-between items-center pb-6">
        <h3 className="text-xl font-['Roboto'] font-bold">Recently Opened</h3>
