            ...
            <Popup open={isOpen} onClose={closeArtworkDetails} contentStyle={contentStyle} overlayStyle={overlayStyle}>
                ...
                <div className="font-['Roboto_Condensed'] px-12 py-2 mb-8">
                    ...
                    {activeTab === "conservation guidelines" && (
                        // <>
                        //     <span className='col-span-5 capitalize'>{artwork.conservation_guidelines.optimal_temperature}</span>
                        //     <span className='col-span-3 capitalize'>{artwork.conservation_guidelines.optimal_humidity}</span>
                        //     <span className='col-span-4 capitalize'>{artwork.conservation_guidelines.light_levels}</span>
                        // </>
